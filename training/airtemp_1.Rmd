...
There is a file provided in the training data, but you can use the code below to download and unzip the latest version from ONS if you want to work with the most up-to-date lookup. The code also ensures we clean up temporary files after use.
...
If you are using the provided file, you can load it directly like so:
```{r}
