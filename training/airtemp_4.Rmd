...
```{r, message=FALSE}
# 1. Temperature + geometry from the 2024 file (built in Part 1) - msoa_temp

# 2. MSOA-level health rank (built in Part 1) - msoa_imd_agg
...
knitr::include_graphics("./hotspot_animation_lite.gif")
```
